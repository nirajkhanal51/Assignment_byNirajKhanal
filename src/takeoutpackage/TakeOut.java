...
public class TakeOut {
    ...
    public static void finalPrice(int[] feeds, double[] prices, int choice, int guestCount) {
        ...
        double tip = TakeOut.getTip(subTotal, .15);
        ...
        System.out.printf("Price per person: $ %.2f\n", TakeOut.pricePerPerson(grandTotal, guestCount));
        System.out.println("Left-over servings for the delivery person: " + TakeOut.determineLeftOvers(feeds[choice - 1], trays, guestCount));
    }
